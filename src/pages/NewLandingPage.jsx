        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <div className="relative">
            <div className="text-center max-w-3xl mx-auto">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-8 leading-tight tracking-tight text-white">
              ...
              <div className="relative mt-20">
                <div className="bg-gradient-to-b from-gray-800 to-gray-700 rounded-xl border border-gray-700 shadow-2xl overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-800 p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-300">Get instant insights into your inventory levels and sales performance</p>
            </div>

            <div className="bg-gray-800 p-6 rounded-lg shadow-sm">
              <div className="w-12 h-12 bg-green-900/20 rounded-lg flex items-center justify-center mb-4">
                <i className="fas fa-boxes text-green-400"></i>
              </div>
              <h3 className="text-lg font-semibold mb-2 text-white">Stock Management</h3>
              <p className="text-gray-300">Track stock levels and get alerts when inventory runs low</p>
            </div>
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-300">Let AI help you optimize stock levels and predict demand</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex justify-center space-x-8 mb-8">
              ...
              <Link to="/documentation" className="text-gray-400 hover:text-white text-sm">Documentation</Link>
