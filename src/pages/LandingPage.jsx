...
export default function LandingPage() {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link to="/documentation" className="text-gray-400 hover:text-white transition-colors text-sm">Docs</Link>
            </div>
  ...
  {/* Hero Section */}
  <section className="pt-32 pb-16 overflow-hidden bg-gray-900">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center">              
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
                ...
                <button className="bg-gray-800 text-white px-8 py-4 rounded-md text-base font-medium hover:bg-gray-700 transition-all duration-200 flex items-center justify-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
                <div
                  key={index}
                  className="p-6 rounded-lg bg-gray-800 border border-gray-700 shadow-sm hover:shadow-md transition-shadow duration-300"
                >
  ...
  <section id="testimonials" className="py-32 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-4xl font-bold mb-6 text-white">
              Trusted by Leaders
            ...
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-gray-800 rounded-xl p-8 border border-gray-700 hover:border-gray-600 transition-all duration-300 hover:shadow-lg">
      ...
      <section className="py-32 relative overflow-hidden bg-gradient-to-r from-blue-600 to-cyan-600">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link to="/signup" className="bg-gray-800 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-gray-700 transition-all duration-300 transform hover:-translate-y-1 shadow-xl">
